        ...
        <div id="navbar" className="navbar-collapse collapse">
          <ul className="nav navbar-nav">
            {this.state.user == null && this.state.token == null ?
              ...
              :
              <li className="active"><Link to="/dashboard" onClick={this.changeActiveLI}>Dashboard</Link></li>
            }
            {this.state.user == null && this.state.token == null ?
              <li id="moviesLink"><Link to="/movies" onClick={this.changeActiveLI}>Movies</Link></li>
              :
              <li id="moviesLink"><Link to="/movies" onClick={this.changeActiveLI}>My Movies</Link></li>
            }
      ...
      <div className="lbox" id="login-section">
           <div className="content">
              ...
              <div className={this.state.isRegistered ? "relogin show" : "relogin hide"}>
                ...
                <a href='javascript:void(0)' onClick={this.reset}>Click here to Login</a>
              </div>
              <div className={this.state.isLoggedIn ? "loginSuccess show" : "loginSuccess hide"}>
                <p> You are logged in!</p>
                Click here for <Link to='dashboard'>Dashboard</Link>
              </div>
